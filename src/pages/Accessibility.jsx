...
export default function Accessibility() {
    ...
    return (
        <SidebarLayout title="Accessibility">
            <div className="rounded-[28px] bg-white border border-slate-200 p-6 space-y-6">
                <div>
                    ...
                    <div className="text-sm text-slate-600 mt-1">
                        These settings are saved to your account and will appear in your Activity Log.
                    </div>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    <Toggle
                        title="Dark Mode"
                        desc="Turn off to use Light Mode."
                    ...
                    <Toggle
                        title="Notifications"
                        desc="Enable payslip and support updates."
                    ...
                    <Toggle
                        title="High Contrast"
                        desc="Improve contrast for better visibility."
